...
(function() {
  var Constants, INDEX_NAME, Indexes, Logger, Neo, SchemaUtil, SchemaValidation, Setup, User, UserSchema, iced, redis, __iced_k, __iced_k_noop, _und,
  ...
  User.get = function(id, cb) {
    var err, resolvedId, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      if (id === "public") {
        (function(__iced_k) {
          ...
          redis.get("user:public", __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
