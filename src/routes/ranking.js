...
(function() {
  var Attribute, Constants, Cypher, CypherBuilder, CypherLinkUtil, Entity, EntityUtil, ErrorDevMessage, Logger, Neo, Permission, Rank, Ranking, Response, Tag, User, basicAuthentication, hasPermission, iced, redis, __iced_k, __iced_k_noop, _create, _delete, _edit, _show, _showDetail, _und;
