...
(function() {
  var Attribute, Constants, Cypher, CypherBuilder, CypherLinkUtil, Data, DataRoute, Entity, EntityUtil, ErrorDevMessage, Link, Logger, Neo, Permission, Remote, Response, Tag, User, Vote, basicAuthentication, getDiscussionId, getRelationId, hasPermission, iced, redis, __iced_k, __iced_k_noop, _addAttribute, _addData, _del, _delAttribute, _delData, _edit, _getAttribute, _getData, _listAttribute, _listData, _show, _showUserVoteDetail, _showUsers, _und, _updateAttributeLink;
