...
(function() {
  var AccessLevel, Attribute, Constants, Cypher, CypherBuilder, CypherLinkUtil, Data, DataRoute, Entity, EntityUtil, ErrorDevMessage, Link, Logger, Neo, NumUtil, Permission, Remote, Response, Slug, Tag, User, Vote, basicAuthentication, getDiscussionId, getRelationId, hasPermission, iced, redis, __iced_k, __iced_k_noop, _addAttribute, _addData, _del, _delAttribute, _delData, _edit, _getAttribute, _getData, _listAttribute, _listData, _show, _showUserVoteDetail, _showUsers, _und, _updateAttributeLink;
  ...
  hasPermission = function(req, res, next, cb) {
    var ErrorResponse, accessLevel, entity, err, errEntity, errUser, reqWithUser, resolvedId, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
        ...
        (function(__iced_k) {
          ...
          Permission.hasPermission(user, entity, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
                return accessLevel = arguments[1];
              };
            })(),
            lineno: 67
          }));
  ...
  exports.create = function(req, res, next) {
    var datas, entity, err, errs, ind, linkData, rels, reqBody, tagName, tagObj, tagObjs, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
      ...
      reqBody.tags = _und.filter(reqBody.tags, function(tag) {
      ...
      (function(__iced_k) {
        ...
        Entity.create(reqBody, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              err = arguments[0];
              return entity = arguments[1];
        ...
        (function(__iced_k) {
          if (user) {
            ...
            (function(__iced_k) {
              ...
              CypherLinkUtil.createMultipleLinks(user._node, entity._node, [Constants.REL_CREATED, Constants.REL_ADMIN, Constants.REL_MODIFIED], linkData, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    err = arguments[0];
          ...
          (function(__iced_k) {
            ...
            return Response.OKResponse(res)(201, entity.serialize());
          });
        });
      });
    });
  ...
  */
  ...
  _addData = function(req, res, next) {
    var dataInput, entity, err, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
