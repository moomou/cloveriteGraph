...
(function() {
  var Attribute, Collection, Constants, Data, Entity, EntityUtil, ErrorDevMessage, Fields, Logger, Neo, OTHER_SPLIT_REGEX, Permission, REL_SPLIT_REGEX, Response, Tag, Vote, cypherQueryConstructor, iced, luceneQueryContructor, queryAnalyzer, searchFunc, searchableClass, serializeEntity, serializeSearchResult, __iced_k, __iced_k_noop, _und;
...
_continue()
  ...
  exports.searchHandler = function(req, res, next) {
    var blobResults, cQuery, cleanedQuery, collectionQuery, entities, err, errU, errs, identified, ind, query, queryParams, rankingName, result, results, searchClass, searchClasses, serialized, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    if (!req.query.q) {
    ...
    (function(__iced_k) {
      ...
      if (collectionQuery) {
        ...
        cQuery = "START n=node:nCollection('name:" + rankingName + "~0.25') MATCH (n)-[r:_RANK]->(x)                RETURN DISTINCT n AS ranking, r.rank AS rank, x AS entity ORDER BY ID(n), r.rank;";
        Neo.query(Collection, cQuery, {}, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              errs = arguments[0];
