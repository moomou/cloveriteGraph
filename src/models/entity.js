...
(function() {
  var Constants, Entity, EntitySchema, INDEX_NAME, Indexes, Logger, Neo, SchemaUtil, SchemaValidation, entityAttrNegVoteRedisKey, entityAttrPosVoteRedisKey, iced, redis, __iced_k, __iced_k_noop, _und,
