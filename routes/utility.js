...
(function() {
  var Attribute, Constants, Entity, Link, SchemaUtil, Tag, User, createLink, createMultipleLinks, db, deleteLink, getOrCreateLink, getRelationId, getStartEndIndex, getUser, hasLink, iced, isAdmin, redis, updateLink, __iced_k, __iced_k_noop, _und;
  ...
  */
  ...
  exports.getRelationId = getRelationId = function(path) {
    var splits;
