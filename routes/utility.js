...
(function() {
  var Attribute, Constants, Entity, Link, SchemaUtil, Tag, User, createLink, createMultipleLinks, crypto, db, getStartEndIndex, getUser, hasLink, iced, isAdmin, redis, __iced_k, __iced_k_noop, _und;
  ...
  */
  ...
  exports.createUser = function(req, res, next) {
    var accessToken, buf, ex, userToken, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
