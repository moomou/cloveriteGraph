...
(function() {
  var Attribute, Comment, Constants, Cypher, CypherBuilder, CypherLinkUtil, Entity, EntityUtil, ErrorDevMessage, Link, Logger, Neo, Remote, Response, SchemaUtil, Tag, User, Utility, Vote, basicAuthentication, getDiscussionId, getRelationId, hasPermission, iced, redis, __iced_k, __iced_k_noop, _addAttribute, _addComment, _del, _delAttribute, _delComment, _edit, _getAttribute, _listAttribute, _listComment, _show, _showUserVoteDetail, _showUsers, _und, _updateAttributeLink;
  ...
  hasPermission = function(req, res, next, cb) {
    var ErrorResponse, authorized, entity, err, errEntity, errUser, reqWithUser, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          EntityUtil.cleanAttributes(entity, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
  ...
  */
              ...
              (function(__iced_k) {
                if (existingLinkData.srcURL !== linkData.srcURL) {
                  (function(__iced_k) {
                    ...
                    Remote.getJSONData(linkData.srcURL, __iced_deferrals.defer({
                      assign_fn: (function() {
                        return function() {
  ...
  _delAttribute = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      startendVal = Utility.getStartEndIndex(attr._node.id, Constants.REL_ATTRIBUTE, entity._node.id);
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "entity.coffee",
