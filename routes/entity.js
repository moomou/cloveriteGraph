...
(function() {
  var Attribute, Comment, Constants, Entity, Link, Logger, Neo, Response, StdSchema, Tag, User, Utility, Vote, getDiscussionId, getJSONData, getOutgoingRelsCypherQuery, hasPermission, iced, redis, rest, __iced_k, __iced_k_noop, _addAttribute, _addComment, _del, _delAttribute, _delComment, _edit, _getAttribute, _listAttribute, _listComment, _show, _showUsers, _und, _updateAttributeLink;
  ...
  hasPermission = function(req, res, next, cb) {
    var authorized, entity, err, errEntity, errUser, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
  ...
  exports.authenticate = function(req, res, next, cb) {
  ...
  */
  ...
  exports.edit = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _edit(req, res, next);
    });
  };

  _edit = function(req, res, next) {
    var blob, entity, err, errs, ind, linkData, pathExists, tagName, tagObj, tagObjs, tags, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
  ...
  */
  ...
  exports.listAttribute = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _listAttribute(req, res, next);
    });
  };
  ...
  exports.addAttribute = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _addAttribute(req, res, next);
    });
  };

  _addAttribute = function(req, res, next) {
    var attr, blob, data, entity, err, errA, errE, errU, existingLinkData, link, linkData, path, rel, relId, splits, user, value, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  exports.delAttribute = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _delAttribute(req, res, next);
    });
  };
  ...
  exports.getAttribute = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _getAttribute(req, res, next);
    });
  };
  ...
  exports.updateAttributeLink = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _updateAttributeLink(req, res, next);
    });
  };
  ...
  */
  ...
  exports.addComment = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _addComment(req, res, next);
    });
  };

  _addComment = function(req, res, next) {
    var cleanedComment, commentObjJson, discussionId, err, result, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    if (!req.body.comment) {
  ...
  exports.listComment = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _listComment(req, res, next);
    });
  };
  ...
  exports.delComment = function(req, res, next) {
    ...
    (function(__iced_k) {
      ...
      return _delComment(req, res, next);
    });
  };
