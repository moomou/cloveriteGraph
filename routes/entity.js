...
(function() {
  ...
  */
  ...
  _delAttribute = function(req, res, next) {
    return Response.ErrorResponse(res)(503, ErrorDevMessage.notImplemented());
  };

  exports.delAttribute = basicAuthentication(_delAttribute);

  _getAttribute = function(req, res, next) {
    var ErrorResponse, attr, attrId, blob, entityId, err, errAttr, errLink, rel, startendVal, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    ErrorResponse = Response.ErrorResponse(res);
