...
(function() {
  var Attribute, Constants, Entity, Link, Logger, Neo, Response, StdSchema, Tag, User, Utility, Vote, getJSONData, getOutgoingRelsCypherQuery, hasPermission, iced, rest, __iced_k, __iced_k_noop, _und;
  ...
  hasPermission = function(req, cb) {
    var entity, err, errEntity, errUser, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      ...
      return Utility.hasPermission(user, entity, cb);
    });
  };
  ...
  */
  ...
  exports.showUsers = function(req, res, next) {
    var authorized, blobs, entity, err, ind, node, nodes, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
