...
(function() {
  var Attribute, Constants, Entity, Link, Neo, Response, StdSchema, Tag, Vote, iced, __iced_k, __iced_k_noop, _und;
  ...
  exports.linkEntity = function(req, res, next) {
    var dstEntity, dst_srcRel, errDst, errSrc, es, et, link, relation, srcEntity, src_dstRel, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
      ...
      (function(__iced_k) {
        ...
        if (relation['src_dst']) {
          ...
          console.log(link);
          srcEntity._node.createRelationshipTo(dstEntity._node, link.name, link.data, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                es = arguments[0];
        ...
        if (relation['dst_src']) {
          ...
          console.log(link);
          dstEntity._node.createRelationshipTo(srcEntity._node, link.name, link.data, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                et = arguments[0];
