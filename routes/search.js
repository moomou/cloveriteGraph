...
(function() {
  var Attribute, Constants, Entity, Neo, OTHER_SPLIT_REGEX, REL_SPLIT_REGEX, SchemaUtil, Tag, Utility, Vote, cypherQueryConstructor, iced, luceneQueryContructor, queryAnalyzer, searchFunc, searchableClass, trim, __iced_k, __iced_k_noop, _und;
  ...
  exports.searchHandler = function(req, res, next) {
    var attrBlobs, authorized, blobResults, cleanedQuery, entity, entitySerialized, err, errU, errs, identified, ind, indX, indY, obj, query, result, results, searchClass, searchClasses, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      ...
      if (err || errU) {
        return res.status(500).json({
          err: "Unable to execute query. Please wait"
        });
      }
      blobResults = [];
      identified = {};
