...
(function() {
  var Attribute, Constants, Entity, EntityUtil, ErrorDevMessage, Fields, Neo, OTHER_SPLIT_REGEX, REL_SPLIT_REGEX, Ranking, Response, SchemaUtil, Tag, Utility, Vote, cypherQueryConstructor, iced, luceneQueryContructor, queryAnalyzer, searchFunc, searchableClass, __iced_k, __iced_k_noop, _und;
  ...
  cypherQueryConstructor = function(searchClass, name, otherMatches, relMatches, skip, limit) {
  ...
  exports.searchHandler = function(req, res, next) {
    var attrBlobs, authorized, blobResults, cQuery, cleanedQuery, dataBlobs, entity, entitySerialized, err, errU, errs, identified, ind, indX, indY, item, obj, query, queryParams, rankingName, rankingQuery, rankingResult, result, resultBlob, results, sRanking, searchClass, searchClasses, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
