...
(function() {
  var Attribute, Constants, Entity, Neo, SchemaUtil, Tag, Utility, Vote, attrSplit, cypherQueryConstructor, iced, luceneQueryContructor, queryAnalyzer, relSplit, searchFunc, searchableClass, trim, __iced_k, __iced_k_noop, _und;
  ...
  exports.searchHandler = function(req, res, next) {
    var attrBlobs, authorized, blobResults, cleanedQuery, entity, entitySerialized, err, errU, identified, ind, indX, indY, obj, query, result, results, searchClass, searchClasses, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
